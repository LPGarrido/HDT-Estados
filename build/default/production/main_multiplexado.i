# 1 "main_multiplexado.s"
# 1 "<built-in>" 1
# 1 "main_multiplexado.s" 2
PROCESSOR 16F887
...
# 25 "main_multiplexado.s" 2

BMODO EQU 0
BACCION EQU 1
# 40 "main_multiplexado.s"
...
INT_PORTB:
    BTFSC PORTD,3 ;
    GOTO $+4
    BTFSC PORTD,2 ;((PORTD) and 07Fh), 1=0; ((PORTD) and 07Fh), 0=0 ESTADO_0; ((PORTD) and 07Fh), 0=1 ESTADO_1
    GOTO ESTADO_1
    GOTO ESTADO_0
    BTFSC PORTD,2 ;((PORTD) and 07Fh), 1=1; ((PORTD) and 07Fh), 0=0 ESTADO_2; ((PORTD) and 07Fh), 0=1 ESTADO_3
    GOTO ESTADO_3
    GOTO ESTADO_2
